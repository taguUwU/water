  ...
  return (
    ...
    >
      ...
      <Animatable.View 
        ...
        duration={1000}
      >   
        <Text style={[styles.title, styles.textShadow]}>WaterEye+</Text>
        <Text style={[styles.subtitle, styles.textShadow]}>用AI看見水的心跳</Text>
        <Text style={[styles.platform, styles.textShadow]}>版本: WaterEye+ v3.0</Text>
      </Animatable.View>
        ...
        <View style={styles.btnContainer}>
          ...
          <View style={styles.btnRow}>
            ...
            <GradientButton 
              ...
              onPress={() => Linking.openURL("https://youtu.be/wMyoTrFEBkM?si=e8qWgAU15Xeivjkb")}
              text="使用教學"
            />
          </View>
        </View>
